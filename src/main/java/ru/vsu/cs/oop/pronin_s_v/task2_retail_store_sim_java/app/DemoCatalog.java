...
/**
 * Вшитый каталог товаров для MVP-сценариев.
 * Позволяет событиям (DeliveryEvent, PurchaseEvent) использовать готовый список продуктов.
 */
public class DemoCatalog {
    ...
    private DemoCatalog() {
        // утилитарный класс — не инстанцируется
    }
}